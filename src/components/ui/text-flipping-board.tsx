...
const ACCENT_COLORS: AccentColor[] = [
  { top: "bg-[#ffe81f]", bottom: "bg-[#cca300]", text: "text-black" },
  { top: "bg-neutral-800", bottom: "bg-neutral-900", text: "text-[#ffe81f]" },
  { top: "bg-zinc-800", bottom: "bg-zinc-900", text: "text-[#ffe81f]" },
  { top: "bg-[#e5d01a]", bottom: "bg-[#b3a214]", text: "text-black" },
  { top: "bg-black", bottom: "bg-[#111]", text: "text-[#ffe81f]" },
];
